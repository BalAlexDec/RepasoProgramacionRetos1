...
//Ex 8
let ex8 = ["hola","hola","Superespia"];
function sumcaracter(arr){//for
    let sum = 0;
...
esParOImpar(5);
//Ex 10
function arraypar(){ //if
    let arr = ["Casa","Coche","Ciudad","Cesta"];
    let arr2 = ["Barco","Baca","Bicicleta","Balon","Bisiesto","Brasil"];
    let arr3= ["Venezuela","Veneno","Voltaje"];
    let sum1=sumcaracter(arr);
    let sum2=sumcaracter(arr2);
    let sum3 =sumcaracter(arr3);

    console.log("Array uno es"+sum1); esParOImpar(sum1);
    console.log("Array dos es"+sum2); esParOImpar(sum2);
    console.log("Array tres es"+sum3); esParOImpar(sum3);
